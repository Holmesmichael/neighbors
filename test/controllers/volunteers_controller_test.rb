...
class VolunteersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create volunteer" do
    assert_difference('Volunteer.count') do
      post volunteers_url, params: { volunteer: { done: @volunteer.done, request_id: @volunteer.request_id, user_id: @volunteer.user_id } }
    end
  ...
  test "should update volunteer" do
    patch volunteer_url(@volunteer), params: { volunteer: { done: @volunteer.done, request_id: @volunteer.request_id, user_id: @volunteer.user_id } }
